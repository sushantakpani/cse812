...
def main(batch_size):
    ...
    #inport model
    model = torch.hub.load('pytorch/vision:v0.5.0', 'resnet18', pretrained=False).to(device)
    ...
    first_conv_layer = torch.nn.Conv2d(1, 64, kernel_size=(3,3), stride=(2, 2), padding=(3, 3), bias=False)
